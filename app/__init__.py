...
def create_app(config_name=None):
    ...
    # Register blueprints
    from app.api import auth, users, tasks, workspaces, income, ai_integration, docs_export, account, content_api, feedback_api, team_api, notification_api, subtask_api, projects
